...
<p align="center">
📜 <strong>License:</strong> GPLv3 | 🐧 <strong>Platform:</strong> Ubuntu (X11) | 🐍 <strong>Python:</strong> 3.x | 🖼️ <strong>UI:</strong> PySide6 | 🔧 <strong>Requires:</strong> xdotool, wmctrl
</p>
